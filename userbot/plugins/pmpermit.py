...
USER_BOT_NO_WARN = ("`Hello ! This is` **F.R.I.D.A.Y**\n"
                    ...
                    f"{CUSTOM_MIDDLE_PMP} \n\n"
                    f" किसी को उसकी इच्छा के बिना निजी संदेश भेजने वाले नामर्द या लेस्बियन होते है😑

और निशा नामर्दों और लेस्बियनों से वार्तालाप नहीं करती😏

इसलिए आप पतली गली से निकल सकते है 👉
अन्यथा किसी भी सामान्य समूह में हमारी मालकिन को टैग कर सकते है।😉 \n\n "
